...
const Layout = ({ title, children, isSecondPage=false }) => {
    ...
    return (
        <>
            <div style={{ height: '12.5vh', width: '100%'}} />
                {children}
            <div className="topbar" style={{backgroundColor:'#6F7CC7', color:'#FFFFFF', display:'flex', justifyContent:'space-between', alignItems:'center', height:'12.5vh'}}>
                <Typography >
